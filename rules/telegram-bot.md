...
## Конфигурация (.env)
TELEGRAM_TOKEN, LLM_API_KEY, LLM_BASE_URL (api.kiro.cheap/v1), LLM_MODEL (claude-haiku-4-5), OPENAI_API_KEY, MCP_RX_URL (:3001), MCP_CRM_URL (:3002), CRM_API_URL (:5099), BOT_PASSWORD, ALLOWED_CHATS
